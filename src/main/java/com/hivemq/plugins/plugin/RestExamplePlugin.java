 ...
 */
@Information(name = "REST Service Example Plugin", author = "Christoph Schaebel", version = "1.0.0-SNAPSHOT")
public class RestExamplePlugin extends HiveMQPluginModule {
    ...
    protected Class<? extends PluginEntryPoint> entryPointClass() {
        return RestExampleEntryPoint.class;
    }
}
